...
## Files
- `chr_pakmat.blend` - editable source (collections EXPORT / COLLISION / REFERENCE)
- `chr_pakmat.fbx` - export (Forward +Z / Up +Y in Unity, 1 unit = 1 m)
...
```
Unity 6000.6.2f1 / URP - round trip for chr_pakmat
Animator: avatar=chr_pakmatAvatar valid=True human=True
  Hips           -> Hips
  Head           -> Head
  LeftHand       -> LeftHand
  RightFoot      -> RightFoot
...
Bounds size (m): 1.748 x 1.688 x 0.584; min.y=0.005
Forward check: toes-ankle = (0.00, -0.06, 0.14) -> faces +Z (OK) (avatar toe mapping: none - optional bone)
Joint heights (m): hips 0.830, head 1.300; root scale (1.00, 1.00, 1.00), mesh node scale (1.00, 1.00, 1.00), importer globalScale 1 useFileScale True fileScale 1
Handedness: left hand x = -0.68 (left is -X, correct for +Z forward)
Mesh: 3936 verts, 7140 tris, 1 material(s), 23 bones, blendshapes: Grin, Alarm, Determined, Blink
